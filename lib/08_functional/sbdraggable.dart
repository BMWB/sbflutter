 ...
 * @LastEditTime: 2021-07-30 10:19:16
...
main(List<String> args) {
  runApp(MaterialApp(
    home: sddraggablescaff(),
  ));
}

class sddraggablescaff extends StatelessWidget {
  const sddraggablescaff({Key? key}) : super(key: key);
...
class _DragTargetDetailsExampleState extends State<DragTargetDetailsExample> {
  ...
  Widget _buildDragTargetChild() => Padding(
      ...
      child: Container(
          ...
          child: Builder(
              builder: (targetContext) => DragTarget(
